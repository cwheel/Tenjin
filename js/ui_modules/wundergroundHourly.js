...
function initModuleWundergroundHourly(updateData) {
	addPage("WundergroundHourly", '<div class=pageIcon style="background-image: url(/src/wunderground.png);"></div><div id="title">6 Hour Weather Report</div><div id="bar"></div><div id="wghour0"></div><div id="wghour1"></div><div id="wghour2"></div><div id="wghour3"></div><div id="wghour4"></div><div id="wghour5"></div>');
}
