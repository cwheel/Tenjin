...
function initModuleNpr(updateData) {
	addPage("Npr",'<div class=pageIcon style="background-image: url(/src/npr.png);"></div><div id=story0></div><div id=story1></div><div id=story2></div><div id=story3></div><div id=story4></div>');
